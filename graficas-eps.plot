...
plot "./cmake-build-debug/prueba-1.tmp" title "Ordenacion por intercambio directo", \
    "./cmake-build-debug/prueba-2.tmp" title "Ordenacion por seleccion directa", \
    "./cmake-build-debug/prueba-3.tmp" title "Ordenacion por insercion directa"